...
const Sidebar = () => {
  ...
  const navItems = [
    ...
    { name: 'Distribution', path: '/manufacturer/distribution', icon: Truck },
    { name: 'Scan & Verify', path: '/manufacturer/scan-verify', icon: ScanLine },
    { name: 'Expiry & Alerts', path: '/manufacturer/expiry-alerts', icon: AlertTriangle },
    { name: 'Sales / Scan Activity', path: '/manufacturer/activity', icon: Activity },
    { name: 'Reports & Analytics', path: '/manufacturer/reports', icon: BarChart3 },
